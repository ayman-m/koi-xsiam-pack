...
const uc2 = [
  ...
  h2("Do"),
  s2("Attach KOI IR - Alert Triage to a KOI alert, or run it on an existing one:"),
...
const uc3 = [
  ...
  h2("Do"),
  s3("Run KOI IR - Investigate Item with an item_id and marketplace."),
  s3("Run KOI IR - Investigate Device with a device id."),
  h2("Expect"),
...
const uc4 = [
  ...
  h2("Do"),
  s4("Run KOI IR - Block and Remediate with an item_id and marketplace."),
  h2("Expect"),
...
const uc5 = [
  ...
  h2("Do"),
  s5("Run KOI Hunting - MCP Server Audit, directly or from a Job."),
...
const uc6 = [
  ...
  s6([{ text: "Run the Refresh job (KOI Script Runner - Refresh Job) " }, { text: "first", bold: true }, { text: "." }]),
  s6("Then run the Scan job (KOI Script Runner - Scan Job)."),
  h2("Expect"),
